function castillear() {
	...
	// Aquí irá el código para dibjar.
		...
		cxt.strokeStyle = "red";
		cxt.strokeRect(190,200,200,300);
		
		cxt.fillStyle = "#123456";   
		cxt.fillRect(200,430,40,40);
		
		cxt.fillStyle = "#123456";   
		cxt.fillRect(200,350,40,40);
		
		cxt.fillStyle = "#123456";   
		cxt.fillRect(200,280,40,40);
		
		cxt.fillStyle = "#123456";   
		cxt.fillRect(300,430,40,40);
		
		cxt.fillStyle = "#123456";   
		cxt.fillRect(300,350,40,40);
		
		cxt.fillStyle = "#123456";   
		cxt.fillRect(300,280,40,40);
